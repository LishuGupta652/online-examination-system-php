            ...
            <div class="row" style="background:#62A2D1">
                <table class="table" width="100%">
                    <tr>
                        ...
                        <td>
                            <font face="Verdana" size="8">Online Examination System</font>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <font face="Verdana" size="3">
                                <marquee>Online Examination in Technical Core Subject for BCA, MCA, B.Tech(CS/IT),
                                    M.Tech(CS/IT)</marquee>
                            </font>
                        </td>
                    </tr>
                </table>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input id="emailInput" placeholder="email address"
                                                        class="form-control" type="email" name="F_email"
                                                        oninvalid="setCustomValidity('Please enter a valid email address!')"
                                                        onchange="try{setCustomValidity('')}catch(e){}" required="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <input class="btn btn-lg btn-primary btn-block" name="fb_submit"
