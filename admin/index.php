  ...
  -->
    <form name="form1" method="POST" action="login.php">
        <table align="center">
            <tr>
                <td>
                    <font color=#228B22 face="Verdana" size=4>Login ID</font>
                </td>
                <td>
                    <font color="BLUE"><input name="loginid" type="text" id="loginid" size="20"
                            style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;">
                </td>
            </tr>
            <tr>
                <td>
                    <font color=#228B22 face="Verdana" size=4>Password</font>
                </td>
