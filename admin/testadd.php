...
<form name="form1" method="post" onSubmit="return check();">
    <table align="center">
        <tr>
            <td>
                <font color=#228B22 face="Verdana" size=4>Choose Subject</font>
            </td>
            <td>
                <style type="text/css">
                .drop_view {
        ...
        <tr>
            <td>
                <font color=#228B22 face="Verdana" size=4>Test Name</font>
            </td>
            <td><input name="testname" type="text" id="testname"
                    style="height:35px;width:238px;font-size:13pt;font-family:Verdana;color:#06535A;border:2px solid #0BC1D2;">
            </td>
        </tr>

        <tr>
            <td>
                <font color=#228B22 face="Verdana" size=4>Total Questions</font>
            </td>
            <td><input name="totque" type="text" id="totque"
                    style="height:35px;width:238px;font-size:13pt;font-family:Verdana;color:#06535A;border:2px solid #0BC1D2;">
            </td>
        </tr>
