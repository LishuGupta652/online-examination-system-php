...
<body>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="29%" bgcolor="#0B4C56" align="center">
                <font face="Verdana" color="#FFFFFF">User Login</font>
            </td>
        </tr>
        <tr>
                ...
                <font face="Verdana">
                    <div align="center">
                        ...
                        <span class="style5">
                            ...
                            <span class="style7"><img src="images/logo2.png" width="300" height="150"></span>
                        </span>
                        ...
                        <blockquote>
                            <p align="left" class="style5"><span class="style7">Welcome to Online
                                    Examination Portal. This Site will provide the test <strong>(Multiple Choice
                                        Questions)</strong> for various core subject of interest.
            ...
            <td valign="top">
                <form name="form1" method="post" action="">
                    <table width="200" border="0">
                        <tr>
                            <td>
                                <font face="Verdana" color="#0B4C56">Login ID </font>
                            </td>
                            <td><input name="loginid" type="text" id="loginid2"
                                    style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <font face="Verdana" color="#0B4C56">Password</font>
                            </td>
                            <td><input name="pass" type="password" id="pass2"
                                    style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;">
                            </td>
                        </tr>
                        <tr>
		  ...
		  ?>
                        ...
                        <tr>
                            <td colspan="2" bgcolor="#0B4C56">
                                <div align="center">
                                    <font face="Verdana" color="#FFFFFF">New User? <a href="signup.php"
                                            style="color: #33C6C2">Register Here</a></font>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" bgcolor="#8585e0">
                                <div align="center">
                                    <font face="Verdana" color="#FFFFFF">Forget Password? <a href="forget.php"
                                            style="color: #000099">Forget pass</a></font>
                                </div>
                            </td>
                        </tr>
                    </table>
