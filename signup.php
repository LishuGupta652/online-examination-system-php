...
?>
    <table width="100%" border="0">
        <tr>
            ...
            <td width="468" height="57" align="center">
                <h1 style="color:#15504E; font-family:Verdana;">New User Register</h1>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <font face="Verdana">
                            <tr>
                                ...
                                <td><input type="text" name="lid"
                                        ...
                                        placeholder="Desired Username"></td>
                            </tr>
                            <tr>
                                <td>
                                    <font face="Verdana">Password
                                </td>
                            ...
                            <tr>
                                <td>
                                    <font face="Verdana">Retype Password
                                </td>
                            ...
                            <tr>
                                <td>
                                    <font face="Verdana">Full Name
                                </td>
                                <td><input name="name" type="text" id="name"
                                        style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;"
                                        placeholder="Desired Full Name"></td>
                            </tr>
                            <tr>
                                <td>
                                    <font face="Verdana">Address
                                </td>
                                <td><textarea name="address" id="address"
                                        style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;"
                                        placeholder="Address Details"></textarea></td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <font face="Verdana">Email ID
                                </td>
                                <td><input name="email" type="text" id="email"
                                        style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;"
                                        placeholder="Valid Email Id"></td>
                            </tr>
                            <tr>
